...
foreign import onDefinition :: forall eff. Connection -> (TextDocumentPositionParams -> Res eff Location) -> Eff (conn :: CONN | eff) Unit
...
foreign import onHover :: forall eff. Connection -> (TextDocumentPositionParams -> Res eff Hover) -> Eff (conn :: CONN | eff) Unit
...
foreign import onWorkspaceSymbol :: forall eff. Connection -> (WorkspaceSymbolParams -> Res eff Hover) -> Eff (conn :: CONN | eff) Unit
